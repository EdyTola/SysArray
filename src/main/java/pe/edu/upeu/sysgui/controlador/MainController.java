...
import pe.edu.upeu.sysgui.Application;
...
public class MainController {
    @Autowired
    private ApplicationContextAssert context;
    @FXML
    ...
    private HBox createHBox(Persona usuario) {
        ...
        Text nombreText = new Text(String.format("%-20s", usuario.getNombre())); // Ajusta el ancho si esnecesario
